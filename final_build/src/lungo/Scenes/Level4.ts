...
export default class Level4 extends GameLevel {
    ...
    loadScene(): void {
        // Load resources
        this.load.tilemap("level4", "final_build/dist/lungo_assets/tilemaps/level4.json");
        ...
        this.load.audio("level_music", "final_build/dist/lungo_assets/music/wunglewoogie.mp3");
