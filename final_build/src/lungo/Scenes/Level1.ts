...
export default class Level1 extends GameLevel {
    ...
    loadScene(): void {
        // Load resources
        this.load.tilemap("level1", "final_build/dist/lungo_assets/tilemaps/level1.json");
        ...
        this.load.audio("level_music", "final_build/dist/lungo_assets/music/cowbell.mp3");
    ...
    startScene(): void {
        ...
        this.addEnemy("bowEnemy", new Vec2(35, 20), {firingCooldown: 2500, projectileStartSpeed:  300, projectileWeight: 2});
